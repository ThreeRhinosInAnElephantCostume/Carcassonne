...
func _enter_tree():
	...
	add_custom_type("TextureRectProp", "TextureRect", preload("res://Props/TextureRectProp.cs"), preload("res://Icons/Nodes/ControlPropIcon.png"))
	add_custom_type("TextureButtonProp", "TextureButton", preload("res://Props/TextureButtonProp.cs"), preload("res://Icons/Nodes/ControlPropIcon.png"))
...
func _exit_tree():
	...
	remove_custom_type("TextureRectProp")
	remove_custom_type("TextureButtonProp")
