...
public class AudioPlayer : Node
{
    ...
    public override void _Ready()
    {
        ...
        Globals.Settings.Audio.EffectsVolume.OnModification += v => SetAudioBusVolume("Sounds", (float)v);
        Globals.Settings.Audio.EffectsVolume.TriggerModified();
        Globals.Settings.Audio.MusicVolume.OnModification += v => SetAudioBusVolume("Music", (float)v);
        Globals.Settings.Audio.MusicVolume.TriggerModified();
        Globals.Settings.Audio.MasterVolume.OnModification += v => SetAudioBusVolume("Master", (float)v);
        Globals.Settings.Audio.MasterVolume.TriggerModified();
    }
    ...
    {
        float volumeToSet = -_muteLevel * value + _muteLevel;
