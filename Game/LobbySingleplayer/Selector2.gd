...
func _on_BotEasyBlue_mouse_entered():
    if(enterPressed):
        return
    currentSelected = 0
    position.y = 130
...
func _on_BotMidBlue_mouse_entered():
    if(enterPressed):
        return
    currentSelected = 1
    position.y = 130 + 206
...
func _on_BotHardBlue_mouse_entered():
    if(enterPressed):
        return
    currentSelected = 2
